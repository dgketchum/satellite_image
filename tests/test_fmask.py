...
class FmaskTestCaseL5(unittest.TestCase):
    def setUp(self):
        self.dirname_cloud = 'testsr/data/fmask_test/lt5_fmask'
...
class FmaskTestCaseL7(unittest.TestCase):
    def setUp(self):
        self.dirname_cloud = 'testsr/data/fmask_test/le7_fmask'
...
class FmaskTestCaseL8(unittest.TestCase):
    def setUp(self):
        self.dirname_cloud = 'testsr/data/fmask_test/lc8_fmask'
